...
(defn collection
  [name]
  (str "com.etzhayyim.aburi." name))

(def cell-specs {
  :analyze {:legacy-cell "cell-aburi-analyze"
     :phase :event
  ...
  :datom-emit {:legacy-cell "cell-aburi-datom-emit"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :coverage {:legacy-cell "cell-aburi-coverage"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :ingest {:legacy-cell "cell-aburi-ingest"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :kotoba-bridge {:legacy-cell "cell-aburi-kotoba-bridge"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "kotoba-bridge")]
     :required-gates common-gates
     :trigger "manifest cell kotoba-bridge"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
